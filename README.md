...
当前版本：0.7.0。[下载安装包](https://github.com/JAYSAYlil/zixu-memory/releases/tag/v0.7.0)。这是沿用开发签名的安卓预览版，可覆盖安装同签名旧版本。
...
新增回答依据校验与确认反馈、安卓密码加密备份、附件大小与分享、存储管理、首次引导、检索摘要和分批数据库读取。安装包由 34.03 MB 减至 27.29 MB。详见 [更新与验证说明](docs/RELEASE-0.7.0.md)。
